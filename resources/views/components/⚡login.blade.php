...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login()
    {
        ...
        $roleSistem = $user->role === 'guru_piket'
            ? 'guru'
            : $user->role;
...
<div>
    ...
    <div class="login-wrapper">
        ...
        <div class="deco-circle" style="top:-120px; right:-120px; width:400px; height:400px;">
        </div>

        <div class="deco-circle" style="top:-60px; right:-60px; width:240px; height:240px;">
        </div>

        <div class="deco-circle" style="bottom:-100px; left:-100px; width:360px; height:360px;">
        </div>
        ...
        <div style="width:100%; max-width:440px; position:relative; z-index:1;">
            ...
            <div class="login-card-header">
                ...
                <div class="fw-bold" style="font-size:21px; color:#fff;">
                    Sistem Informasi
                </div>

                <div class="fw-bold" style="font-size:21px; color:#60a5fa;">
                    Jurnal &amp; Absensi Guru
                </div>
            ...
            <div class="login-card-body">
                ...
                <form wire:submit.prevent="login">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model="nip" class="form-control-custom"
                            placeholder="Masukkan NIP atau ID Anda" required autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" wire:model="password" class="form-control-custom"
                ...
                <div class="text-center mt-3">
                    ...
                    <button type="button" wire:click="$set('showForgot', true)" style="font-size:13px;
                ...
                <div class="text-center mb-4">
                    ...
                    <div class="text-muted mt-2" style="font-size:13px; line-height:1.6;">
                ...
                <div class="p-3 mb-4" style="background:#f3f6fb;
                                border-radius:10px;
                                border:1px solid var(--border);">

                    <div class="fw-bold mb-1" style="font-size:12px;">
                ...
                <button type="button" wire:click="$set('showForgot', false)" class="btn w-100" style="padding:12px;
                               background:var(--bg);
                               color:var(--text);
