...
new class extends Component
{
    public function getNotifikasiProperty()
    {
        ...
        return DB::table('dispensasi_penerima')
            ...
            ->leftJoin(
                'pengguna as guru_piket',
                'dispensasi.id_guru_piket',
                '=',
                'guru_piket.id_pengguna'
            )
            ->where(
            ...
            ->select(
                ...
                'guru_piket.nama as nama_guru_piket'
            )
            ->orderByRaw(
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fw-semibold">
                            {{ $notif->jenis_surat ?? 'Dispensasi' }} · {{ $notif->jenis_dispensasi }}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fw-semibold">
                            {{ $notif->nama_wakasek ?? $notif->nama_guru_piket ?? '-' }}
                        </div>

                    </div>

                    @if ($notif->status === 'Ditolak' && $notif->catatan_wakasek)
                    <div class="col-12">
                        <div class="text-muted small mb-1">Alasan Penolakan</div>
                        <div class="p-3 bg-light rounded">{{ $notif->catatan_wakasek }}</div>
                    </div>
                    @endif
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 flex-wrap">
                    ...
                    <button wire:click="tandaiDibaca({{ $notif->id_penerima }})" class="btn btn-sm btn-outline-primary">
                        ✓ Tandai Dibaca
                    </button>
