...
<div class="d-flex flex-wrap gap-3 mt-3 pt-3"
    ...
    {{-- ============================================================
         TAB SECTION (Paket 4): Jadwal Hari Ini / Jurnal Saya / Dispensasi Masuk
         Semua data tab ini sudah diambil lewat computed property saat
         halaman dimuat, jadi ganti tab TIDAK query ulang ke server --
         cukup x-show/x-data dari Alpine.js (dibawa otomatis oleh Livewire 4).
    ============================================================ --}}
    <div x-data="{ tabAktif: 'jadwal' }">
            ...
            <li class="nav-item">
                ...
                >
                    ...
                    @if($this->menungguCount > 0)
                        <span class="badge bg-warning text-dark ms-1">{{ $this->menungguCount }}</span>
                    @endif
                </button>
            </li>
        ...
        {{-- TAB 2: JURNAL SAYA (dulu "AGENDA HARI INI") --}}
